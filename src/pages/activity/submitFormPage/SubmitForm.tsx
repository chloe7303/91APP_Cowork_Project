...
export default function SubmitForm({
	...
	return (
		<>
			{" "}
			<form autoComplete="off" id={id} onSubmit={handleSubmit(onSubmit)}>
					...
					<div>
						<div className="flex">
							<input
								...
								type="checkbox"
								value=""
								className="w-4 h-4 rounded-[3px] border border-solid border-[#BBBCBB] "
							...
							>
								...
								<a
									href="#"
									className="text-[#428BCA] dark:text-blue-500 hover:underline"
								>
									隱私權及網站使用條款
								</a>
							</label>
